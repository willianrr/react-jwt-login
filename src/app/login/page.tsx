        ...
        <div className="flex flex-wrap items-center py-8">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Acessar portal</span>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                  <button
                    disabled={loading}
                    className="w-full flex disabled:opacity-75 justify-center items-center rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                  >
                    <svg
                      width="20"
                      height="20"
